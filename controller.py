...
class VehicleController:
    ...
    def get_next_traj_point(self, current_point):
        ...
        if current_index is not None and current_index + 1 < len(self.traj):
            return self.traj[current_index + 1]["data"]["position"]
        else:
    ...
    def update(self):
        ...
        if current_time - self.previous_time >= 0.1:
            ...
            # 更新可视化
            self.update_visualization(pos,current_way_point, next_way_point)

            # 更新上一帧的时间
            self.previous_time = current_time

    def update_visualization(self, pos,current_way_point, next_way_point):
        """
